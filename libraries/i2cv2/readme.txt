I wrote this library for use with simple slave devices like real
...
There are two classes, SoftI2cMaster and TwiMaster.  They are both
derived from the TwoWireBase base class.  This allows applications to
use either library by only changing the class type.

SoftI2cMaster is a software i2c library that can use any two Arduino
pins for SDA and SCL.  It has an i2c clock rate of about 65 kHz.

TwiMaster uses the ATmega TWI hardware so you must use the hardware
SDA and SCL pins.  It is setup with a i2c clock rate of 400 kHz.

To install the this library, copy the folder I2cMaster to your
libraries directory.

I am including an application, softDS1307.pde to illustrate use
of these libraries.  You must connect a DS1307 real time clock to
the correct pins to run this application.
...
If USE_SOFT_I2C is nonzero, connect the DS1307 SDA to analog pin 4 and
SCL to analog pin 5 of a 168/328 or Mega Arduino
...
pin 5.  On a Mega SDA is pin 20 and SCL is pin 22.
